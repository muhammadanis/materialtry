...
import id.co.veritrans.materialtryout.utils.GUIUtils;
...
public class ColorActivity extends Activity{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ObjectAnimator animX = ObjectAnimator.ofFloat(fabButton, "x", 50f);
        ObjectAnimator animY = ObjectAnimator.ofFloat(fabButton, "y", 100f);
